...
function circle() {
  ...
  circle.center = function (_) {
    return arguments.length
      ? ((center = typeof _ === 'function' ? _ : constant([+_[0], +_[1]])), circle)
      : center;
  };
...
var d3geo = {};
d3geo.geoAlbers = albers;
d3geo.geoAlbersUsa = albersUsa;
d3geo.geoArea = area;
d3geo.geoAzimuthalEqualArea = azimuthalEqualArea;
d3geo.geoAzimuthalEqualAreaRaw = azimuthalEqualAreaRaw;
d3geo.geoAzimuthalEquidistant = azimuthalEquidistant;
d3geo.geoAzimuthalEquidistantRaw = azimuthalEquidistantRaw;
d3geo.geoBounds = bounds;
d3geo.geoCentroid = centroid;
d3geo.geoCircle = circle;
d3geo.geoClipAntimeridian = clipAntimeridian;
d3geo.geoClipCircle = clipCircle;
d3geo.geoClipExtent = extent;
d3geo.geoClipRectangle = clipRectangle;
d3geo.geoConicConformal = conicConformal;
d3geo.geoConicConformalRaw = conicConformalRaw;
d3geo.geoConicEqualArea = conicEqualArea;
d3geo.geoConicEqualAreaRaw = conicEqualAreaRaw;
d3geo.geoConicEquidistant = conicEquidistant;
d3geo.geoConicEquidistantRaw = conicEquidistantRaw;
d3geo.geoContains = contains;
d3geo.geoDistance = distance;
d3geo.geoEqualEarth = equalEarth;
d3geo.geoEqualEarthRaw = equalEarthRaw;
d3geo.geoEquirectangular = equirectangular;
d3geo.geoEquirectangularRaw = equirectangularRaw;
d3geo.geoGnomonic = gnomonic;
d3geo.geoGnomonicRaw = gnomonicRaw;
d3geo.geoGraticule = graticule;
d3geo.geoGraticule10 = graticule10;
d3geo.geoIdentity = identity;
d3geo.geoInterpolate = interpolate;
d3geo.geoLength = length;
d3geo.geoMercator = mercator;
d3geo.geoMercatorRaw = mercatorRaw;
d3geo.geoNaturalEarth1 = naturalEarth1;
d3geo.geoNaturalEarth1Raw = naturalEarth1Raw;
d3geo.geoOrthographic = orthographic;
d3geo.geoOrthographicRaw = orthographicRaw;
d3geo.geoPath = index;
d3geo.geoProjection = projection;
d3geo.geoProjectionMutator = projectionMutator;
d3geo.geoRotation = rotation;
d3geo.geoStereographic = stereographic;
d3geo.geoStereographicRaw = stereographicRaw;
d3geo.geoStream = geoStream;
d3geo.geoTransform = transform;
d3geo.geoTransverseMercator = transverseMercator;
d3geo.geoTransverseMercatorRaw = transverseMercatorRaw;
